...
import { calculateExperience, getCompanySizeLabel, professionalExperiences } from './professional-experience.config';
        ...
        <div class="container mx-auto max-w-6xl px-4">
            ...
            >
                <div class="flex items-end justify-between border-b border-gray-700 pb-6">
                    <div>
                        <h2 class="text-3xl font-bold text-white md:text-4xl">Professional <span class="text-purple-400">Experience</span></h2>
            ...
            >
                        ...
                        <div class="flex-1">
                            <div class="mb-2 flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-4">
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="text-xl font-medium text-purple-400">@</span>
                                    <span class="text-xl font-medium text-purple-400">{{
                                        professionalExperiences[activeExperienceIndex].company
                                    }}</span>
                                </div>
                            </div>
                            ...
                            <div class="mb-4 flex flex-wrap items-center gap-4 text-sm text-gray-400">
                                <div class="flex items-center gap-1">
                                    ...
                                    {{ formatDate(professionalExperiences[activeExperienceIndex].startDate) }} -
                                    {{
                                        professionalExperiences[activeExperienceIndex].endDate
                                            ? formatDate(professionalExperiences[activeExperienceIndex].endDate)
                                            : 'Present'
                                    }}
                                </div>
                                <div class="flex items-center gap-1">
                                    ...
                                    {{
                                        getExperienceDuration(
                                            professionalExperiences[activeExperienceIndex].startDate,
                                            professionalExperiences[activeExperienceIndex].endDate,
                                        )
                                    }}
                                </div>
                ...
                <!-- Expanded Details -->
                <div v-if="isExpanded" class="animate-fadeIn border-t border-gray-700 pt-6" @click.stop>
                    <!-- Key Achievements -->
                    <div v-if="professionalExperiences[activeExperienceIndex]?.keyAchievements?.length" class="mb-8">
