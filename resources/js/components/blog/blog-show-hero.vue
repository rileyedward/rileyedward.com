...
import { Props } from '@/types/components/blog/blog-show-hero';
...
<template>
    <section class="relative flex min-h-[40vh] flex-col items-center justify-center overflow-hidden bg-[#111]">
        <retro-grid />
